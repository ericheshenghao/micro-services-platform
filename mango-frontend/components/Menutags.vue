<template>
  ...
  <div class="avue-tags" @click="contextmenuFlag = false">
    ...
    <div class="avue-tags__box avue-tags__box--close">
      <el-tabs
        v-model="active"
        type="card"
        editable
...
export default class MenuTags extends Vue {
  active = ''
  contentmenuX = ''
  contentmenuY = ''
  ...
  get tagWel() {
    return this.$store.state.tagWel
  }
  ...
  generateTitle(item) {
    ...
    return   item.label==null?"404":item.query.label==null?"首页":item.query.label
  }
